...
from tools.ascii_generator import (
    generate_category_ascii, clear_screen, spinner_animation, typing_animation,
    progress_bar, display_system_info, animated_login_attempt
)
from tools.ip_tools.ip_tools import ip_tools_menu
from tools.fivem_tools.fivem_tools import fivem_tools_menu
from tools.discord_tools.discord_tools import discord_tools_menu
from tools.network_security.network_security_tools import network_security_tools_menu
from tools.system_tools.system_tools import system_tools_menu
from tools.crypto_tools.crypto_tools import crypto_tools_menu
...
class LoginSystem:
    ...
    def user_dashboard(self):
        while self.current_user:
            ...
            print(f"{Fore.CYAN}[5]{Style.RESET_ALL} Network Security Tools")
            print(f"{Fore.CYAN}[6]{Style.RESET_ALL} System Tools")
            print(f"{Fore.CYAN}[7]{Style.RESET_ALL} Cryptography Tools")
            print(f"{Fore.CYAN}[8]{Style.RESET_ALL} Change Password")
            print(f"{Fore.CYAN}[9]{Style.RESET_ALL} Logout")
            print("\n" + "=" * 60 + "\n")
            ...
            if choice == '1':
                ...
                spinner_animation(1, "Loading Network Security tools")
                network_security_tools_menu()
            elif choice == '6':
                spinner_animation(1, "Loading System tools")
                system_tools_menu()
            elif choice == '7':
                spinner_animation(1, "Loading Cryptography tools")
                crypto_tools_menu()
            elif choice == '8':
    ...
    def user_management_menu(self):
        while True:
            clear_screen()
            print(generate_category_ascii("USER MANAGEMENT"))
            display_system_info()
